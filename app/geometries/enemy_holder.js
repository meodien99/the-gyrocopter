...
EnemiesHolder.prototype.rotateEnnemies = function(enemiesPool, airPlane, particlesPool, particlesHolder, deltaTime,GAME_VARIABLES, ambientLight){
   for(var i = 0; i < this.enemiesInUse.length; i++){
      var e = this.enemiesInUse[i];
      e.angle += GAME.SPEED * deltaTime * GAME.ENEMIES_SPEED;
      ...
      var diffPos = airPlane.mesh.position.clone().sub(e.mesh.position.clone());
